...
<header>
  <nav id="nav">
    <ul>
      ...
      <li><a href="${pageContext.request.contextPath}/webfront.jsp" target="_blank" title="HTML5 / CSS3">HTML5 / CSS3</a></li>
      <li><a href="${pageContext.request.contextPath}/jstt.jsp" target="_blank" title="技术探讨">技术探讨</a></li>
      <li><a href="${pageContext.request.contextPath}/life.jsp" target="_blank" title="慢生活">慢生活</a></li>
      <li><a href="${pageContext.request.contextPath}/newstalk.jsp" target="_blank" title="碎言碎语">碎言碎语</a></li>
      <li><a href="${pageContext.request.contextPath}/jsex.jsp" target="_blank" title="JS 实例代码演示">JS实例</a></li>
    </ul>
